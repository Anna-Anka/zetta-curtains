...
plugins.gulp.task('favicons', (done) => {
    const faviconIco = () => {
        plugins.del.sync([`${paths.productFolder}{apple-touch-icon.png,favicon.ico,site.webmanifest}`]);
    ...
    plugins.del.sync([paths.favicons.app]);
